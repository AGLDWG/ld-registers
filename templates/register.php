...
<div style="float:right; text-align:center; background-color:#eee; width:350px; padding:5px;">
    ...
    <p>See this register's <a href="http://linked.data.gov.au/org/connegp">Conneg P Description page</a> for specifics.</p>
</div>

<div>
    Linked data Registers:
    <a href="http://linked.data.gov.au/def/">Definitional Items</a> |
    <a href="http://linked.data.gov.au/dataset/">Datasets</a> |
    <a href="http://linked.data.gov.au/org/">Organisations</a>
</div>
